...
public interface DelphiListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#formalParams}.
	 * @param ctx the parse tree
	 */
	void enterFormalParams(DelphiParser.FormalParamsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#formalParams}.
	 * @param ctx the parse tree
	 */
	void exitFormalParams(DelphiParser.FormalParamsContext ctx);
	/**
	 * Enter a parse tree produced by {@link DelphiParser#actualParams}.
	 * @param ctx the parse tree
	 */
	void enterActualParams(DelphiParser.ActualParamsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#actualParams}.
	 * @param ctx the parse tree
	 */
	void exitActualParams(DelphiParser.ActualParamsContext ctx);
	/**
	 * Enter a parse tree produced by {@link DelphiParser#functionDef}.
	 * @param ctx the parse tree
	 */
	void enterFunctionDef(DelphiParser.FunctionDefContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#functionDef}.
	 * @param ctx the parse tree
	 */
	void exitFunctionDef(DelphiParser.FunctionDefContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DelphiParser#returnStmt}.
	 * @param ctx the parse tree
	 */
	void enterReturnStmt(DelphiParser.ReturnStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#returnStmt}.
	 * @param ctx the parse tree
	 */
	void exitReturnStmt(DelphiParser.ReturnStmtContext ctx);
	/**
	 * Enter a parse tree produced by {@link DelphiParser#procedureDef}.
	 * @param ctx the parse tree
	 */
	void enterProcedureDef(DelphiParser.ProcedureDefContext ctx);
	/**
	 * Exit a parse tree produced by {@link DelphiParser#procedureDef}.
	 * @param ctx the parse tree
	 */
	void exitProcedureDef(DelphiParser.ProcedureDefContext ctx);
	/**
