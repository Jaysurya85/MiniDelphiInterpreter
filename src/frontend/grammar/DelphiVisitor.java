...
public interface DelphiVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DelphiParser#functionDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionDef(DelphiParser.FunctionDefContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DelphiParser#returnStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturnStmt(DelphiParser.ReturnStmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link DelphiParser#procedureDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProcedureDef(DelphiParser.ProcedureDefContext ctx);
	/**
